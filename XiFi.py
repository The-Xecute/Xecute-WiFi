...
def setupDirectories():
    ...
    # Rename older .XIFI data dir to .OneShot-Extended, and maintain compatibility
    old_dir = os.path.expanduser('~/.XIFI')
    new_dir = os.path.expanduser('~/.Xecute-WiFi')

    if os.path.exists(old_dir):
        try:
            os.rename(old_dir, new_dir)
            print('[*] Renamed legacy data directory')
        except XIFIrror as e:
